...
def dataTransform(data,use_cuda):
...
def load_data(args):
    print("================================Dataset================================")
    # print("Dataset:{}, expID:{}, lr:{}, beta:{}, rho:{}, dropout:{}, lamda:{}, max_clamp:{}".format(args.dataset,
    #                                                                                                 args.expID, args.lr,
    #                                                                                                 args.beta, args.rho,
    #                                                                                                 args.dropout,
    #                                                                                                 args.lamda,
    #                                                                                                 args.max_clamp))
    print("Dataset:{}, expID:{}, lr:{}, alpha_base:{}".format(args.dataset, args.expID, args.lr, args.alpha_base))
    dataset,expID,flipRate,cuda = args.dataset,args.expID,args.flipRate,args.cuda

    # dataset, use_cuda, inter_degree, covar_degree =args.dataset, args.use_cuda, args.inter_degree, args.covar_degree
    ...
    return trainA, trainX, trainT, cfTrainT, POTrain, cfPOTrain,\
           ...
           test_t1z1, test_t1z0, test_t0z0, test_t0z7, test_t0z2
